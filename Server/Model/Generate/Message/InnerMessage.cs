...
namespace ET
{
	...
	[ResponseType(nameof(G2L_DisconentGateUnit))]
	[Message(InnerOpcode.L2G_DisconentGateUnit)]
	[ProtoContract]
	public partial class L2G_DisconentGateUnit: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.G2L_DisconentGateUnit)]
	[ProtoContract]
	public partial class G2L_DisconentGateUnit: Object, IActorResponse
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
